...
export default function EditarDirectorioPage() {
  ...
  const loadCliente = async () => {
    try {
      ...
      const clienteData = await clientesAPI.getById(clienteId)
      ...
      setFormData({
        ...
        doc_tipo: clienteData.doc_tipo,
        doc_numero: clienteData.doc_numero,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await clientesAPI.update(cliente.id, {
        ...
        doc_numero: formData.doc_numero,
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            {tipoPersona === "natural" ? `${formData.nombres} ${formData.apellidos}` : formData.razon_social}
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <Label>Tipo de Persona</Label>
              <Select value={tipoPersona} onValueChange={(value) => setTipoPersona(value as TipoPersona)}>
                <SelectTrigger disabled>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="doc_tipo">Tipo de Documento</Label>
                <Select value={formData.doc_tipo} onValueChange={(value) => setFormData({ ...formData, doc_tipo: value as TipoDocumento })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
