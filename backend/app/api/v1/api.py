...
from app.api.v1.endpoints import auth, procesos, audiencias, finanzas, directorio, dashboard, notificaciones, partes_proceso, bitacora, resoluciones, usuarios, diligencias
